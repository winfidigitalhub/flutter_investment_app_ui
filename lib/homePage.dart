...
import 'package:investment/Buy%20App%20Page.dart';
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  height: 50,
                  child: Center(child: Text("Invest",style: TextStyle(color: Colors.white,fontSize: 24,fontWeight: FontWeight.w600),)),
                ),
              ),
              SizedBox(height: 25,)
            ],
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("Investment Plans",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 24),textAlign: TextAlign.start,),
          SizedBox(height: 15,),
            ...
            child: Row(
              children: [
                ...
                InkWell(
                    ...
                    child: DepositItem(name: "Fast Invest",detail: "7.5% per day",icon: Icon(Icons.bar_chart,color: Colors.blue,),)),
                InkWell(
                    splashColor: Colors.grey,
                    onTap: (){
                      Navigator.push(
                    ...
                    child: DepositItem(name: "daily Invest",detail: "5% per day",icon: Icon(Icons.bar_chart,color: Colors.greenAccent,),)),
                InkWell(
                    splashColor: Colors.grey,
                    onTap: (){
                      Navigator.push(
                    ...
                    child: DepositItem(name: "monthly Invest",detail: "30% per month",icon: Icon(Icons.bar_chart,color: Colors.orangeAccent,),))
